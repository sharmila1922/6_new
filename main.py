...
class AddLocationScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.request_permissions()  # Call permission request in the constructor
    ...
    def request_permissions(self):
        if platform == 'android':
            ...
            permission_name = permission.READ_EXTERNAL_STORAGE

            has_permission = package_manager.checkPermission(permission_name, context.getPackageName()) == 0
            if not has_permission:
                request_code = 1  # You can use any integer as the request code
        ...
        try:
            ...
            if service_ids:  # Check if service_ids list is not empty
                ...
                for service_booking in service_provider_view_requests:
                    ...
                    box1.add_widget(Widget(size_hint_y=None, height=dp(10)))  # Adjust the height value as needed
        ...
        try:
            ...
            if customer_details is not None:
                ...
                customer_name_data_label = MDLabel(
                    ...
                    theme_text_color="Custom",
                    text_color=(1, 1, 1, 1),
                    font_size=sp(24),  # Adjust font size
                    font_style="Caption",
                    size_hint_y=None,  # Fixed height
                    height=30,
            ...
            Status = MDLabel(
                ...
                font_style="Caption",
                font_size=sp(50), # Adjust font size to be extra large
                size_hint_y=None,  # Fixed height
                height=30,  # Set the height of the label
                bold=True,
                halign='center'
